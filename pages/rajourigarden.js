  ...
  return (
    <div className=" border-2 border-red-500 rounded-lg h-70 w-full mb-5 p-5">
      <div className="flex">
        ...
        <div className=" ml-20">
          <h2 className="font-bold text-3xl line-clamp-1">Vaishnav PG</h2>
          <p className=" text-justify my-5 text-lg">Boys PG best in rajouri garden with all essential facilities with sharing rooms</p>
